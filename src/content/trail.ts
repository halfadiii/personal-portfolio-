 ...
 * a list of things everybody already agrees with, and the six figures quoted
 * here are all measured and all reproducible from the data in this repository.
 *
...
export const trailChapters: Chapter[] = [
  ...
  },
  {
    ...
    figure: { value: "120s", label: "the window that separates the two" },
  },
  {
    id: "impossible",
    index: "03",
    ...
    figure: {
      value: "18 / 2,315",
      label: "frames whose mark count could not exist",
    },
  },
  {
    id: "shape",
    ...
    figure: {
      value: "192",
      label: "good frames, every one captured before the first defect",
    },
  },
  {
    id: "measure",
    ...
    figure: { value: "0 of 5", label: "intervals that excluded zero" },
  },
  {
    id: "answer",
    index: "06",
